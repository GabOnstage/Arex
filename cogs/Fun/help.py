...
CATEGORIES = {
    ...
    "gaming": {
        ...
        "commands": [
            ...
            "`/roblox rotector user info|plain|batch|status-batch|discord` — Rotector user lookups.",
            "`/roblox rotector group info|plain|batch|tracked` — Rotector group lookups.",
            "`/roblox rotector discord info|batch` — Rotector Discord lookups.",
